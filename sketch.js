...
function setup(){
    ...
    //3rd row from above
    b8 = new Box2(350,420,20,50);
    b9 = new Box2(370,420,20,50);
    b10 = new Box2(390,420,20,50);
    b11 = new Box2(410,420,20,50);
    b12 = new Box2(430,420,20,50);
    ...
    //second stack
    //bottom row 
    b17 = new Box2(700,220,20,50);
    b18 = new Box2(720,220,20,50);
    b19 = new Box2(740,220,20,50);
    b20 = new Box2(760,220,20,50);
    b21 = new Box2(780,220,20,50);
